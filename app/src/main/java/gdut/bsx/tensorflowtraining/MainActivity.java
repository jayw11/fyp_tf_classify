...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final int REQUEST_CROP_PHOTO = 332;
    ...
    private static final float IMAGE_STD = 255; //1;
    private static final String INPUT_NAME = "module_apply_default/hub_input/Mul";
    private static final String OUTPUT_NAME = "final_result";
    private static final String MODEL_FILE = "file:///android_asset/model/inv3_new.pb";
    private static final String LABEL_FILE = "file:///android_asset/model/output_labels_new.txt";
    ...
    public Uri cropPhoto(Uri uri) {
        ...
        return Uri.fromFile(cropPhotoFile);
    }
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case PICTURE_REQUEST_CODE:
                    ...
                    break;
                case OPEN_SETTING_REQUEST_COED:
                    requestMultiplePermissions();
                    break;
                case TAKE_PHOTO_REQUEST_CODE:
                    handleInputPhoto(cropPhoto(currentTakePhotoUri));
                    break;
